                    ...
                    <div>
                        ...
                        <div className='flex flex-wrap space-x-2 mt-2'>
                            {movie.genres?.map(genre => (
                                <a href="#" key={genre.id} className="bg-gray-100 hover:bg-gray-200 text-dark text-sm font-semibold px-2.5 py-1 rounded-lg border border-gray-400 inline-flex items-center justify-center">{genre.name}</a>
                            ))}
                        </div>
                    </div>
                    <div>

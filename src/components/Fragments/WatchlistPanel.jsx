...
const WatchlistPanel = ({isOpenWatchlist, setIsOpenWatchlist}) => {
    ...
    return (
        <div className={`${isOpenWatchlist ? '' : 'hidden'} z-10 py-2 max-w-sm min-w-20 max-h-96 overflow-y-scroll absolute -bottom-0.5 right-7 translate-y-full text-light bg-dark rounded-md`} onMouseLeave={() => setIsOpenWatchlist(false)}>
